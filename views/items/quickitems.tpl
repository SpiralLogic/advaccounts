  <form>
  {#$menu->startTab('Items', 'Items', '#')#} <div id="Items" class="width40 formbox" style='display:none'>
  ...
  {#$menu->endTab()->startTab('Accounts', 'Accounts')#} <div id="Accounts" class="formbox width40">
  ...
  {#$menu->endTab()->startTab('Selling', 'Selling')#}      <iframe id='sellFrame' data-src='{{BASE_URL}}inventory/prices.php?frame=1&stock_id={{$item->stock_id}}' style='width:95%' height='500' frameborder='0'></iframe>

  {#$menu->endTab()->startTab('Purchasing', 'Purchasing')#}      <iframe id='buyFrame' data-src='{{BASE_URL}}inventory/purchasing_data.php?frame=1&stock_id={{$item->stock_id}}' style='width:100%' height='500' frameborder='0'></iframe>

  {#$menu->endTab()->startTab('Locations', 'Locations')#}      <iframe id='locationFrame' data-src='{{BASE_URL}}inventory/reorder_level.php?frame=1&stock_id={{$item->stock_id}}' style='width:100%' height='500' frameborder='0'></iframe>

  {#$menu->endTab()->startTab('Website', 'Website')#}  <iframe id='webFrame' data-srcpre='{{Config::_get('modules.webstore')['product_url']}}' data-srcpost='{{Config::_get('modules.webstore')['url_extension']}}'
                                                                   style='width:100%'

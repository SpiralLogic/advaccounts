 ...
 */
  ...
  class Barcode {
    ...
    static public function gd($res, $color, $x, $y, $angle, $datas, $width = null, $height = null){
      return self::_draw( $res, $color, $x, $y, $angle, $datas, $width, $height);
    }

    static private function _draw( $res, $color, $x, $y, $angle,  $datas, $width, $height){
      $code  = '';
      $rect  = false;

 ...
 */
	...
	class Database_PDO_Connection extends Database_Connection {
		...
		public function connect() {
			...
			extract($this->_config['connection'] + array('dsn' => '', 'username' => NULL, 'password' => NULL, 'persistent' => FALSE,));
		...
		public function list_tables($like = NULL) {
			throw new Adv_Exception('Database method ' . __METHOD__ . ' is not supported by ' . __CLASS__);
		}

<?php
	...
	class Page
	{
		...
		public static function footer($no_menu = false, $is_index = false, $hide_back_link = false)
		{
			...
			var_dump(Files::convert_size(memory_get_usage(true)));
			echo "<br>";
			var_dump(Files::convert_size(memory_get_peak_usage(true)));
			echo "<br>";
			var_dump(Dates::getReadableTime(microtime(true) - FUEL_START_TIME));
			echo "<br>";
			echo "<p></p>";
			echo "</div></body>";

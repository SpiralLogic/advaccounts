<?php
	...
	if (isset($_GET['AddedID'])) {
		$_SESSION['Items'] = new Order_Sales(ST_SALESINVOICE, $_GET['AddedID']);
	...
	elseif (isset($_GET['UpdatedID'])) {
		$_SESSION['Items'] = new Order_Sales(ST_SALESINVOICE, $_GET['UpdatedID']);
		$customer          = new Contacts_Customer($_SESSION['Items']->customer_id);
		$emails            = $customer->getEmailAddresses();
	...
	if ((isset($_GET['DeliveryNumber']) && ($_GET['DeliveryNumber'] > 0)) || isset($_GET['BatchInvoice'])) {
		...
		$dn = new Order_Sales(ST_CUSTDELIVERY, $src, true);
	...
	elseif (isset($_GET['ModifyInvoice']) && $_GET['ModifyInvoice'] > 0) {
		...
		processing_start();
		$_SESSION['Items'] = new Order_Sales(ST_SALESINVOICE, $_GET['ModifyInvoice']);
		...
		processing_start();
		$_SESSION['Items'] = new Order_Sales(ST_SALESINVOICE, $_GET['ViewInvoice']);
		copy_from_cart();

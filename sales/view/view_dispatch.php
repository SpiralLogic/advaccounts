<?php
  ...
  end_row();
  start_row();
  label_cells(_("Dispatch Date"), Dates::sql2date($myrow["tran_date"]), "class='label'", ' class="nowrap"');
  ...
  label_row(_("TOTAL VALUE"), $display_total, "colspan=6 class='right'", ' class="right nowrap"');
  end_table(1);

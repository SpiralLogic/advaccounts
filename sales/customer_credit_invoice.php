<?php
	...
	if (isset($_GET['AddedID'])) {
		...
		ui_msgs::display_warning(REDIT;

		ui_msgs::display_warning(ication_centered(_("Credit Note has been processed"));
	...
	function display_credit_items() {
		...
		label_cells(_("Crediting Invoice"), ui_view::get_customer_trans_view_str(ST_SALESINVOICE, array_keys(
					$_SESSION['Items']->src_docs)), "class='tableheader2'");
		...
		date_row(_("Credit Note Date"), 'CreditDate', '',

<?php
	 ...
	 ***********************************************************************/
	function update_company_gl_setup($retained_act, $profit_loss_act, $debtors_act, $pyt_discount_act, $creditors_act, $freight_act, $exchange_diff_act, $bank_charge_act, $default_sales_act, $default_sales_discount_act, $default_prompt_payment_act, $default_inventory_act, $default_cogs_act,
	...
	function update_company_setup($coy_name, $coy_no, $gst_no, $tax_prd, $tax_last, $postal_address, $phone, $fax, $email, $coy_logo, $domicile, $Dimension, $curr_default, $f_year, $no_item_list, $no_customer_list, $no_supplier_list, $base_sales, $time_zone, $add_pct, $round_to, $login_tout) {
		if ($f_year == null) {
			$f_year = 0;
		}

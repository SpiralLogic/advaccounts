...
*/\n\n";
	...
	function write_lang() {
		...
		$conn = array_natsort(Config::get(null, null, 'installed_languages'), 'code', 'code');
	...
	function db_drop_db($connection) {
		...
		foreach ($all_tables as $table)
		{
			...
			DBOld::query("DROP TABLE `" . $table['Name'] . "`");
		}
	...
	function db_backup($conn, $ext = 'no', $comm = '') {
		$filename = $conn['dbname'] . "_" . date("Ymd_Hi") . ".sql";

		return db_export($conn, $filename, $ext, $comm);
	}
	...
	function create_comp_dirs($path, $comp_subdirs) {

 ...
 ***********************************************************************/
  ...
  function voiding_controls() {
	 ...
	 text_row(_("Transaction #:"), 'trans_no', null, 100, 10100);
  ...
  function check_valid_entries() {
	 ...
	 if (!is_array($_POST['trans_no']) && (!is_numeric($_POST['trans_no'])) AND $_POST['trans_no'] <= 0) {
  ...
  function handle_void_transaction() {
	 $ret = '';
	 if (stristr($_POST['trans_no'],',')) {
		$trans = explode(',', $_POST['trans_no']);
		foreach ($trans as $tran) {
		  $ret .= void_transaction($_POST['filterType'], $tran,

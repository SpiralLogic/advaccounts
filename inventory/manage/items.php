 ...
 ***********************************************************************/
 ...
 if ($dim >= 1) {
	...
	if ($dim > 1) dimensions_list_row(_("Dimension") . " 2", 'dimension2_id', null, true, " ", false, 2);
 }
 ...
 if ($check_remove_image) check_row(_("Delete Image:"), 'del_image');
 check_row(_("Exclude from sales:"), 'no_sale');
 ...
 if (!isset($_POST['NewStockID']) || $new_item) {
	...
	submit('Cancel', _("New Item"), true, '', true);

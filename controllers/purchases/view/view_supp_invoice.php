<?php
    ...
    Table::start('tablestyle width95');
    Row::label(_("Sub Total"), $display_sub_tot, "class='alignright'", "class='alignright nowrap width15'");
    ...
    Row::label(_("TOTAL INVOICE"), $display_total, "colspan=1 class='alignright'", ' class="alignright nowrap"');
    Table::end(1);

<?php
  ...
  if (isset($_GET[ADDED_ID])) {
    ...
    if (!isset($_GET['Updated'])) {
      Event::success(_("Purchase Order: " . Session::history[ST_PURCHORDER] . " has been entered"));
    } else {
      Event::success(_("Purchase Order: " . Session::history[ST_PURCHORDER] . " has been updated"));
    }

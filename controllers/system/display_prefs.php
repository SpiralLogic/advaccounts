<?php
  ...
  if (isset($_POST['setprefs'])) {
    if (!is_numeric($_POST['query_size']) || ($_POST['query_size'] < 1)) {
      ...
      User::i()
        ->update_prefs($_POST['prices'], $_POST['Quantities'], $_POST['Rates'], $_POST['Percent'], Forms::hasPost('show_gl'), Forms::hasPost('show_codes'), $_POST['date_format'], $_POST['date_sep'], $_POST['tho_sep'], $_POST['dec_sep'], $_POST['theme'], $_POST['page_size'], Forms::hasPost('show_hints'),
        $_POST['profile'], Forms::hasPost('rep_popup'), (int) ($_POST['query_size']), Forms::hasPost('graphic_links'), $_POST['language'], Forms::hasPost('sticky_doc_date'), $_POST['startup_tab']);
      if ($chg_lang) {

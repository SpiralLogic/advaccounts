<?php
  ...
  $view->set('totals', ['balance'=> Num::_priceFormat($balance), 'due'=> Num::_priceFormat($due), 'overdue1'=> Num::_priceFormat($overdue1), 'overdue2'=> Num::_priceFormat($overdue2), 'overdue3'=> Num::_priceFormat($overdue2)]);
  $view->set('rows', $rows);
  $view->render();
  Page::end();

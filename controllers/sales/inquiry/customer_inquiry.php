  ...
  class SalesInquirey extends \ADV\App\Controller\Base
  {
    ...
    protected function index() {
      ...
      $cols = array(
        ...
        _("Order")    => array('fun' => [$this, 'formatOrder']), _("Reference") => array('ord' => ''), //
    ...
    function formatDropdown($row) {
      ...
      if ($row['type'] == ST_SALESINVOICE) {
        $edit_url = $this->formatEditBtn($row);  $items[] = ['label'=> 'Edit', 'href'=> $edit_url];
        $title    = 'Edit';
      }
      ...
      $items[] = ['class'=> 'printlink', 'label'=> 'Print '.$caption, 'href'=> $href];

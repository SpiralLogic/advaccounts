    ...
    if ($input_error != 1) {
      ...
      if ($selected_account) {
        if (GL_Account::update($_POST['account_code'], $_POST['account_name'], $_POST['account_type'], $_POST['account_code2'])
          ...
          DB::updateRecordStatus($_POST['account_code'], $_POST['inactive'], 'chart_master', 'account_code');

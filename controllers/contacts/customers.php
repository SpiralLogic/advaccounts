<?php
  ...
  Table::section(1);
  Table::sectionTitle(_("Accounts Details:"), 2);
   Forms::percentRow(_("Discount Percent:"), 'discount', $customer->discount, (User::i()->can_access(SA_CUSTOMER_CREDIT)) ? "" : " disabled");
   Forms::percentRow(_("Prompt Payment Discount Percent:"), 'payment_discount', $customer->payment_discount, (User::i()->can_access(SA_CUSTOMER_CREDIT)) ? "" :
    " disabled");
   Forms::AmountRow(_("Credit Limit:"), 'credit_limit', $customer->credit_limit, null, null, 0, (User::i()->can_access(SA_CUSTOMER_CREDIT)) ? "" :
    " disabled");   Forms::textRow(_("GSTNo:"), 'tax_id', $customer->tax_id, null, 40);

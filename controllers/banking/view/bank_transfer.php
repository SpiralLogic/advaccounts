<?php
  ...
  Cell::labelled(_("Amount"), Num::_format(-$from_trans['amount'], User::price_dec()), '', "class='alignright'");
  if ($show_currencies) {
    echo '</tr>';
    echo '<tr>';
  }
  ...
  if ($show_both_amounts) {
    Cell::labelled(_("Amount"), Num::_format($to_trans['amount'], User::price_dec()), '', "class='alignright'");
  }
  echo '</tr>';
  echo '<tr>';

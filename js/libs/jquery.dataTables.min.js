...
(function (i, wa, p) {
	...
	o.oPagination = {two_button:{fnInit:function (g, l, r) {
		...
		l.appendChild(s);
		l.appendChild(w);
		i(s).bind("click.DT", function () {g.oApi._fnPageChange(g, "previous") && r(g)});
		i(w).bind("click.DT", function () {g.oApi._fnPageChange(g, "next") && r(g)});
		i(s).bind("selectstart.DT", function () {return false});
		...
		l.appendChild(G);
		l.appendChild(x);
		i(s).bind("click.DT", function () {g.oApi._fnPageChange(g, "first") && r(g)});
		i(w).bind("click.DT", function () {g.oApi._fnPageChange(g, "previous") && r(g)});
		i(G).bind("click.DT", function () {g.oApi._fnPageChange(g, "next") && r(g)});
		i(x).bind("click.DT", function () {g.oApi._fnPageChange(g, "last") && r(g)});
		i("span", l).bind("mousedown.DT",
											function () {return false}).bind("selectstart.DT",
		...
		if (g.aanFeatures.p) {
			...
			x = g.aanFeatures.p;
			var z, Y = function (L) {//noinspection PointlessArithmeticExpressionJS
	...
	o.oSort = {"string-asc":function (g, l) {
		...
		return l -
					 g
	}, "numeric-asc":function (g, l) {//noinspection PointlessArithmeticExpressionJS,PointlessArithmeticExpressionJS
		return(g == "-" || g === "" ? 0 : g * 1) - (l == "-" || l === "" ? 0 : l * 1)
	}, "numeric-desc":function (g, l) {//noinspection PointlessArithmeticExpressionJS,PointlessArithmeticExpressionJS
	...
	i.fn.dataTable = function (g) {
		...
		function za(a) {
			if (a.bAjaxDataGet) {
				...
				a.fnServerData.call(a.oInstance, a.sAjaxSource, c, function (h) {Aa(a, h)}, a);
				return false
			} else {
				return true
			}
		...
		function Aa(a, b) {
			if (typeof b.sEcho != "undefined") { //noinspection PointlessArithmeticExpressionJS
				if (b.sEcho * 1 < a.iDraw) {
					return;
				} else { //noinspection PointlessArithmeticExpressionJS
					a.iDraw = b.sEcho * 1;
				}
			}
		...
		function Ia(a) {
			...
			a.nTFoot !== null && P(function (B) {B.style.width = ""}, k.getElementsByTagName("tr"));
		...
		function Na(a) {
			if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
				...
				e = a.fnRecordsDisplay() === 0 && a.fnRecordsDisplay() == a.fnRecordsTotal() ? a.oLanguage.sInfoEmpty + a.oLanguage.sInfoPostFix : a.fnRecordsDisplay() === 0 ? a.oLanguage.sInfoEmpty + " " + a.oLanguage.sInfoFiltered.replace("_MAX_",
																																																																																																																				 j) + a.oLanguage.sInfoPostFix : a.fnRecordsDisplay() == a.fnRecordsTotal() ? a.oLanguage.sInfo.replace("_START_",
																																																																																																																																																																								e).replace("_END_",
																																																																																																																																																																													 h).replace("_TOTAL_",
																																																																																																																																																																																			k) + a.oLanguage.sInfoPostFix : a.oLanguage.sInfo.replace("_START_",
																																																																																																																																																																																																																e).replace("_END_",
																																																																																																																																																																																																																					 h).replace("_TOTAL_",
																																																																																																																																																																																																																											k) + " " + a.oLanguage.sInfoFiltered.replace("_MAX_",
																																																																																																																																																																																																																																																	 a.fnFormatNumber(a.fnRecordsTotal())) + a.oLanguage.sInfoPostFix;
		...
		function Ta(a, b) {
			if (a.oFeatures.bStateSave) {
				...
				if (d !== null && d !== "") {
					try {c = typeof i.parseJSON == "function" ? i.parseJSON(d.replace(/'/g, '"')) : eval("(" + d + ")")} catch (e) {return}
					d =
					0;
		...
		function Sa(a, b, c, d, f) {
			...
			if ((ta(a) !== null ? p.cookie.length : b.length + p.cookie.length) + 10 > 4096) {
				...
				for (var j = 0, k = a.length; j < k; j++) {
					if (a[j].indexOf(d) != -1) {
						var m = a[j].split("=");
						try {h = eval("(" + decodeURIComponent(m[1]) + ")")} catch (t) {continue}
		...
		function W(a, b) {
			...
			for (j = b.length; d < j; d++) {
				...
				for (k = b[d].childNodes.length; f < k; f++) {
					c = b[d].childNodes[f];
					if (c.nodeName.toUpperCase() == "TD" || c.nodeName.toUpperCase() == "TH") {//noinspection PointlessArithmeticExpressionJS,PointlessArithmeticExpressionJS
		...
		function Z(a) {
			if (a === null) {
				...
				return function (c) {return a(c)};
								 ...
								 "string" && a.indexOf(".") != -1) {
				var b = a.split(".");
				return b.length == 2 ? function (c) {return c[b[0]][b[1]]} : b.length == 3 ? function (c) {return c[b[0]][b[1]][b[2]]} : function (c) {
					for (var d = 0, f = b.length; d < f; d++) {
						c = c[b[d]];
					}
					return c
		...
		this.fnSettings = function () {return A(this[o.iApiIndex])};
		...
		this.fnSortListener = function (a, b, c) {ga(A(this[o.iApiIndex]), a, b, c)};
		...
		this.fnUpdate = function (a, b, c, d, f) {
			...
			} else {//noinspection SillyAssignmentJS
				a = a;
				N(e, b, c, a);
				...
				if (typeof g !=
					...
					if (typeof g.oLanguage != "undefined") {
						if (typeof g.oLanguage.sUrl != "undefined" && g.oLanguage.sUrl !==
							...
							i.getJSON(e.oLanguage.sUrl, null, function (t) {y(e, t, true)});
							h = true
						} else {

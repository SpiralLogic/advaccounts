		...
		*/
         ...
         function write1DBarcode($code, $type, $x = '', $y = '', $w = '', $h = '', $xres = 0.4, $style = '', $align = '') {
            ...
            if ($style["text"]) {
               ...
               $this->Cell(($arrcode["maxw"] * $xres), ($this->cell_height_ratio * $fontsize / $this->k), $code, 0, 0, 'C', 0, '',
                                                                                                          $style["stretchtext"]);
            }
                        ...
                        if (isset($dom[$key]['attribute']['size'])) {
                           if ($key > 0) {
                              if ($dom[$key]['attribute']['size']{0} == "+") {
                                 $dom[$key]['fontsize'] =
                                    $dom[($dom[$key]['parent'])]['fontsize'] + intval(substr($dom[$key]['attribute']['size'], 1));

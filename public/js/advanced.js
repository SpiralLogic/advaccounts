...
$(function () {
  $('#topmenu').children('li').on({
                                  });
  $('#topmenu').children('li').children('a').on({
                                                  focus:      function () {$(this).parent().addClass('hover'); }//
                                                  , focusout: function () {$(this).parent().removeClass('hover'); }//
                                                });
  $('#topmenu').find('ul').find('a').on({keydown: function () {
    switch (event.which) {
      case 37:
      ...
      case 38:
        ...
        break;
      case 39:
        console.log($(this).parent().parent().css('display', 'none').parent().next().find('ul').find('a').eq(0).focus());
  ...
  }, mouseleave:                                  function () {console.log(document.activeElement)}, mouseenter: function () {

             ...
             Forms:        (function () {
               ...
               return {
                 ...
                 error:          function (field, error, type) {
                   ...
                   tooltip
                     = field.addClass('error').tooltip({title:function () {return error;}, trigger:'manual', placement:'right', class:type}).tooltip('show');
             ...
             postcode:     (function () {
               ...
               return {
                 add:  function (set, city, state, code) {
                   sets[set]
                     = {city:$(document.getElementsByName(city)), state:$(document.getElementsByName(state)), postcode:$(document.getElementsByName(code))}
                 },

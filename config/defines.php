<?php
  ...
  return array(
    ...
    'ICON_PDF' => "pdf.gif",
    'ICON_DOC' => "invoice.gif",
    'ICON_CREDIT' => "credit.gif",
    'ICON_RECEIVE' => "receive.gif",
    'ICON_DOWN' => "download.gif",
    'ICON_MONEY' => "money.png",
    'ICON_REMOVE' => "remove.png",
    'ICON_REPORT' => "report.png",
    'ICON_VIEW' => "view.gif",
    'ICON_SUBMIT' => "ok.gif",
    'ICON_ESCAPE' => "escape.png",
    'DEFAULT_TAX_GROUP' => 1,
    'DEFAULT_AREA' => 1,
    'DEFAULT_SHIP_VIA' => 1,
    ...
    'SS_SPEC' => 3 << 8, // special administration
    'SS_SALES_C' => 11 << 8, // configuration
    'SS_SALES' => 12 << 8, // transactions
    'SS_SALES_A' => 13 << 8, // analytic functions/reports/inquires
    'SS_PURCH_C' => 21 << 8,
    'SS_PURCH' => 22 << 8,
    'SS_PURCH_A' => 23 << 8,
    'SS_ITEMS_C' => 31 << 8,
    ...
    //	GL account classes
    //
    'CL_NONE' => 0, // for backward compatibility
    'CL_ASSETS' => 1,
    'CL_LIABILITIES' => 2,
    'CL_EQUITY' => 3,
    'CL_INCOME' => 4,

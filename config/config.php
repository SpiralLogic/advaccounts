<?php
	 ...
	 */
	return array(
		'debug' => false, 'debug_sql' => false, 'debug_pdf' => false, 'debug_query_log' => false, 'debug_select_log' => false, 'errors_throttling' => 10, // Log file for error/warning messages. Should be set to any location
		...
		'accounts_stock_emailnotify' => false, 'accounts_allocation_allowance' => 0.005, /* use old style convert (income and expense in BS, PL) */
		'accounts_gl_oldconvertstyle' => false, /* print_invoice_no. 0 = print reference number, 1 = print invoice number */
		'print_useinvoicenumber' => 1, 'auth_salt' => '342342134sdfgsgdf', 'ui_date_format' => 1, 'ui_date_seperator' => '/', 'use_fiscalyear' => false, /* Default border and spacing for tables
		...
		'valid_charged_to_delivered_qty' => true, /* System check to see if price charged on purchase invoices exceeds the purchase order price.
							 If this parameter is checked the proportion by which the purchase invoice is an overcharge
							 referred to before reporting an error */
		'valid_charged_to_delivered_price' => true, 'demo_mode' => false, 'item_images_width' => 80, 'item_images_height' => 50, 'item_images_max_size' => 500, 'company_default' => 1, 'company_subdirs' => array('images', 'pdf_files', 'backup', 'js_cache', 'reporting', 'attachments'), 'graphs_skin' => 1, 'db_default' => array(
			'name' => 'fa', 'user' => 'fa', 'pass' => '1willenberg', 'host' => 'localhost', 'port' => 3306, 'debug' => false), 'formats_date' => array("MMDDYYYY", "DDMMYYYY", "YYYYMMDD"), 'separators_thousands' => array(",", ".", " "), 'separators_decimal' => array(".", ","), 'separators_date' => array('/', ".", "-", " "), 'formats_paper_size' => array("Letter", "A4"), 'default_lang' => 'en_AU',);

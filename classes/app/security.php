<?php
  ...
  class Security
  {
     ...
     * @param $page_security
     */
    function check_page($page_security)
    {
     ...
     * @param $areas
     */
    public function add_role($name, $description, $sections, $areas)
    {
      $sql
        = "INSERT INTO security_roles (role, description, sections, areas) VALUES (" . //
        DB::escape($name) . "," . //
     ...
     * @param $areas
     */
    public function update_role($id, $name, $description, $sections, $areas)
    {
     ...
     * @return mixed
     */
    public function check_role_used($id)
    {
     ...
     * @param bool $show_inactive
     */
    public function  roles_cells($label, $name, $selected_id = NULL, $new_item = FALSE, $submit_on_change = FALSE, $show_inactive = FALSE)
    {
      if ($label != NULL) {
        echo "<td>$label</td>\n";
      }
      echo "<td>";
      echo $this->roles($name, $selected_id, $new_item, $submit_on_change, $show_inactive);
      echo "</td>\n";
    }
    /**
     * @static
    ...
    public function  roles_row($label, $name, $selected_id = NULL, $new_item = FALSE, $submit_on_change = FALSE, $show_inactive = FALSE)
    {
      ...
      $this->roles_cells(NULL, $name, $selected_id, $new_item, $submit_on_change, $show_inactive);
      echo "</tr>\n";
    }
    /**
     * @static

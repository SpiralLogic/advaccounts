<?php
  ...
  class Person extends \ADV\App\DB\Base
  {
    ...
    protected function canProcess() {
      ...
      $this->provision2 = Validation::is_num($this->provision2, 0, $this->break_pt);

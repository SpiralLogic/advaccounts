<?php
  ...
  class Item extends Base
  {
    ...
    protected function _read($id = null, $extra = array()) {
      ...
      DB::select()->from('stock_master')->where('id=', $id)->fetch()->intoObject($this);
    }
    /**
     * @return bool
     */
    ...
    public static function adjust_deliveries($stock_id, $material_cost, $to) {
      ...
      if ($diff != 0) {
        ...
        if (!Dates::isDateInFiscalYear($to)) {
          $to = Dates::endFiscalYear();
        }

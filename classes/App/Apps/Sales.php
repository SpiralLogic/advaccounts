<?php
  ...
  class Sales extends Application
  {
    ...
    public function buildMenu() {
      ...
      $module->addRightFunction(3, _('Sales &Persons'), '/sales/manage/sales_people?', SA_SALESMAN);
      $module->addRightFunction(3, _('Sales &Areas'), '/sales/manage/sales_areas?', SA_SALESAREA);
      $module->addRightFunction(3, _('Sales &Groups'), '/sales/manage/sales_groups?', SA_SALESGROUP);
    }
  }

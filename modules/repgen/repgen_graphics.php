...
<?php
	...
	$txt .= "</select></td>";
	echo $txt;
	$txt = "<td>" . IT_X1 . " <input type='text' name='x1' size='4' maxlength='4' value='" . (isset($x1) ? $x1
	 : "") . "' onBlur='num_test(this);'></td>\n";
	echo $txt;
	$txt = "<td>" . IT_Y1 . " <input type='text' name='y1' size='4' maxlength='4' value='" . (isset($y1) ? $y1
	 : "") . "' onBlur='num_test(this);'></td>\n";
	echo $txt;
	$txt = "<td>" . IT_X2 . " <input type='text' name='x2' size='4' maxlength='4' value='" . (isset($x2) ? $x2
	 : "") . "' onBlur='num_test(this);'></td>\n";
	echo $txt;
	$txt = "<td>" . IT_Y2 . " <input type='text' name='y2' size='4' maxlength='4' value='" . (isset($y2) ? $y2
	 : "") . "' onBlur='num_test(this);'></td>\n";
	echo $txt;
	$txt = "<td>" . IT_WIDTH . " <input type='text' name='width' size='4' maxlength='4' value='" . (isset($width) ? $width
	 : "") . "' onBlur='num_test(this);'></td>\n";
	echo $txt;
	end_row();
	end_table(1);

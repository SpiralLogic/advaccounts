/*  Prototype JavaScript framework, version 1.5.rc1
...
Object.extend(Object.extend(Ajax.Updater.prototype, Ajax.Request.prototype), {
	initialize:function(container, url, options) {
		this.containers = {
			success:container.success ? Prototype$(container.success) : Prototype$(container),
			failure:container.failure ? Prototype$(container.failure) :
							(container.success ? null : Prototype$(container))
		}
...
Form.Methods = {
	serialize:function(form) {
		var elements = Form.getElements(Prototype$(form));
...
var Position = {
	...
	clone:function(source, target) {
		...
		var p = Position.Page::start(source);
		...
		if (Element.getStyle(target, 'position') == 'absolute') {
			...
			delta = Position.Page::start(parent);
		}

<?php
	...
	if (!Input::get('frame')) {
		...
		$shortcuts->addLink('Create Quote', 'Create Quote for this customer!', '/sales/sales_order_entry.php?type=32&new='.ST_SALESQUOTE.'&customer_id=', 'id');
		$shortcuts->addLink('Create Order', 'Create Order for this customer!', '/sales/sales_order_entry.php?type=30&new='.ST_SALESORDER.'&customer_id=', 'id');
